...
insert into especialidade(id_especialidade, nome_especialidade) values(2, 'Clúnico Geral');
...
--
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(1, 'Lucas Borges', 1472581234, 745896, 'alexborges@gmail.com', 'Residente', 6); 
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(2, 'Joao Silva', '74126956', '123789', 'joaofelix@gmail.com', 'Residente', 7);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(3, 'Gabriel Azevedo', '78531045', '569745', 'dantas.azevedo@gmail.com', 'Interno', 1);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(4, 'Carolina dos Santos', '47965816', '459781', 'cristianagouvea@gmail.com', 'Residente', 5);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(5, 'Guilherme Souza', '14736985', '123780', 'carlosmonteiro@hotmail.com', 'Especialista', 6);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(6, 'Thayna Carvalho', '36407814', '014698', 'izabelastevens@gmail.com', 'Residente', 2);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(7, 'Diego Machado', '12047896', '814362', 'douglasdmachado@gmail.com', 'Interno', 3);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(8, 'Valter dos Anjos Oliveira', '47158296', '654782', 'vitor.anjos@gmail.com', 'Especialista', 1);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(9, 'Marcos Chagas', '47915768', '487127', 'mirandaChagas@gmail.com', 'Especialista', 2);
...
--
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(1, 'Daniela Sousa', 74851574, '415879');
...
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(6, 'Francisco Afonso de Sousa', 20147896, '894175');
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(7, 'Patricia de Almeida', 12047953, '784196');
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(8, 'Diogo Silva', 2143608, '254987');
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(9, 'Pedro Augusto', 74198569, '120478');
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(10,'Gabriela Souza', 88742514, '251369');
